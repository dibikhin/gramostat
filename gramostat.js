...
// var import_script = (function (oHead) {
	...
	// function fOnload() { console.log('Script loaded.'); }

	// return function (sSrc) {
		// console.log('Loading the lib.');
...
(function() {
	...
	// fetch_common_followers(323124269, 510162439) // 323124269 - Тома , 510162439 - Алена)
	...
	function export_followers(id) {
		...
		// while (page_info.has_next_page && cnt < 11) {
